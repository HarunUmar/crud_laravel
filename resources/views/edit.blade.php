...
@section('content')
           ...
           <div class="col-md-12 ">
                ...
                <form method="POST" action="{{route('edit')}}" class="form-horizontal">
                ...
                <label for="name" class="col-md-4 control-label">Id Barang</label> 
                   ...
                   <input type="hidden" name="_token" value="{{csrf_token()}}">
                        ...
                        <input id="id_barang" type="text" name="id_barang" value="{{$result->id_barang}}
                ...
                <label for="name" class="col-md-4 control-label">Nama Barang</label> 
                    <div class="col-md-6">
                        <input id="name" type="text" name="nama_barang" value="{{$result->nama_barang}}" required="" autofocus="autofocus" class="form-control">
                    </div>
                </div> 
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="date" name="tanggal_masuk" value="{{$result->tanggal_masuk}}">
                    </div>
                </div>
